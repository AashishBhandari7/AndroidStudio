...
public class AddEditTaskActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    // Fields for views
    EditText mEditText,titleEditText,targetEditText;
    ...
    private void initViews() {
        ...
        targetEditText = findViewById(R.id.etTarget);
    ...
    private void populateUI(TaskEntry task) {
        ...
        targetEditText.setText(task.getTarget());
    ...
    public void onSaveButtonClicked() {
        ...
        Date date = new Date();
        TaskEntry todo = new TaskEntry(title, target, description, priority, date);
        if(mTaskId == DEFAULT_TASK_ID)
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        TextView textView = (TextView) findViewById(R.id.etTarget);
